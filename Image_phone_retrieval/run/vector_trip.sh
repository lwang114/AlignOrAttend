...
srun -u --output=run/vector_tripop.outputs python run_phone.py --losstype tripop --feature vector --data_dir /tudelft.net/staff-bulk/ewi/insy/MMC/xinsheng/data/coco
